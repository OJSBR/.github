...
|--------|--------------|----------|----------|
| [epubJsViewer](https://github.com/OJSBR/epubJsViewer) | Embedded EPUB reader (zoom, table of contents, reading modes) powered by epub.js; continues the `epubViewer` by Lepidus Tecnologia, discontinued in 2025 when the Bibi engine stopped being maintained | 3.5 | [Releases](https://github.com/OJSBR/epubJsViewer/releases) |
...
| [ojsbrFilenameRename](https://github.com/OJSBR/ojsbrFilenameRename) | Delivers submission files under a neutral, standardized name on download, translated into the language of the reader or of the journal (38 languages), or as numbers only | 3.4 · 3.5 | [Releases](https://github.com/OJSBR/ojsbrFilenameRename/releases) |
...
| [coauthorAlert](https://github.com/OJSBR/coauthorAlert) | Warns authors of supervised work to add their supervisor as a co-author before submitting, with a live single-author indicator and a required acknowledgement | 3.5 | [Releases](https://github.com/OJSBR/coauthorAlert/releases) |
| [coAuthorParticipants](https://github.com/OJSBR/coAuthorParticipants) | Turns co-authors into participant users of the submission with the author role, with an individual email; automatic and by command line backfill | 3.5 | [Releases](https://github.com/OJSBR/coAuthorParticipants/releases) |
...
| [audioPlayerOmp](https://github.com/OJSBR/audioPlayerOmp) | Turns a book's audio files into a listenable audiobook: play button per file, player bar with seeking, continuous playback, speed and resume; serves the file with full HTTP Range support | 3.5 | [Releases](https://github.com/OJSBR/audioPlayerOmp/releases) |
| [pdfFlipbookOmp](https://github.com/OJSBR/pdfFlipbookOmp) | Page-turning (flipbook) reading mode for PDF monographs, beside the native viewer and never replacing it | 3.5 (preview) | [Releases](https://github.com/OJSBR/pdfFlipbookOmp/releases) |
