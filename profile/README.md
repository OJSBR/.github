...
| [audioPlayer](https://github.com/OJSBR/audioPlayer) | Turns a book's audio files into a listenable audiobook: play button per file, player bar with seeking, continuous playback, speed and resume; serves the file with full HTTP Range support | 3.5 | [Releases](https://github.com/OJSBR/audioPlayerOmp/releases) |
| [pdfFlipbook](https://github.com/OJSBR/pdfFlipbook) | Page-turning (flipbook) reading mode for PDF monographs, beside the native viewer and never replacing it | 3.5 (preview) | [Releases](https://github.com/OJSBR/pdfFlipbookOmp/releases) |
